        ...
        <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-cardbg rounded-lg p-4 relative overflow-hidden">
                    <div className="text-5xl font-bold text-yellow-500 mb-2">{orders.length}</div>
                    <div
                ...
                <div className="bg-cardbg rounded-lg p-4 relative overflow-hidden">
                    <div className="text-5xl font-bold text-red-500 mb-2">{orders.filter(item => item.status === "PENDING").length}</div>
                    <div
                ...
                <div className="bg-cardbg rounded-lg p-4 relative overflow-hidden">
                    <div className="text-5xl font-bold text-green-500 mb-2">{orders.filter(item => item.status === "DELIVERED").length}</div>
                    <div
